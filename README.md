# genpark-composable-runnable-expression-chain-orchestrator-skill
...
> **GenPark AI Agent Skill** -- Composable runnable expression language and streaming chain orchestrator (LangChain LCEL style)
